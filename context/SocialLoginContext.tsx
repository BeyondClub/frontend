...
// const SocialLogin = dynamic(() => import('@biconomy/web3-auth'), { ssr: false });

interface web3AuthContextType {
	connect: () => Promise<any | null | undefined>;
...
export const Web3AuthProvider = ({ children }: any) => {
	...
	const [socialLoginSDK, setSocialLoginSDK] = useState<any | null>(null);
	...
	useEffect(() => {
		const initWallet = async () => {
			import('@biconomy/web3-auth').then(async (SocialLogin: any) => {
				...
				const sdk = new SocialLogin.default();
